...
public class NestedSpotTracker implements TrackerSegmenter, TestableProcessingPlugin, Hint, HintSimple {
    ...
    NumberParameter maxLinkingDistance = new BoundedNumberParameter("Maximum Linking Distance (FTF)", 2, 0.4, 0, null).setHint("Maximum distance for frame-to-frame linking, (in µm). If two spots in two successive frames are separated by a distance larger than this distance, they cannot be linked together."+calibrationTT);
