...
public class NestedSpotTracker implements TrackerSegmenter, TestableProcessingPlugin, HintSimple {
    ...
    ObjectClassParameter compartmentStructure = new ObjectClassParameter("Bacteria Object Class", -1, false, false).setEmphasized(true).setHint("Select the bacteria Object class containing spots to be tracked.");
    ...
    BooleanParameter projectOnSameSide = new BooleanParameter("Correct Rotation", true).setHint("This option allows correcting for motion due to the rotation of the bacteria around its longitudinal axis.");
