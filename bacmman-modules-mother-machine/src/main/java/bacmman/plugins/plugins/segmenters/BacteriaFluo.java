...
public class BacteriaFluo extends BacteriaIntensitySegmenter<BacteriaFluo> implements HintSimple {
    ...
    public enum CONTOUR_ADJUSTMENT_METHOD {NO_LOCAL_THLD, LOCAL_THLD_IQR}
    ...
    ConditionalParameter<THRESHOLD_COMPUTATION> foreThldCond = new ConditionalParameter<>(foreThresholdMethod).setActionParameters(THRESHOLD_COMPUTATION.CURRENT_FRAME, foreThresholderFrame).setActionParameters(THRESHOLD_COMPUTATION.ROOT_TRACK, foreThresholder).setActionParameters(THRESHOLD_COMPUTATION.PARENT_TRACK, foreThresholder)
    ...
    ConditionalParameter<BACKGROUND_REMOVAL> backgroundSelCond = new ConditionalParameter<>(backgroundSel)
            ...
            .setActionParameters(BACKGROUND_REMOVAL.THRESHOLDING, foregroundEdgeFusionThld, bckThldCond)
    ...
    ConditionalParameter<FOREGROUND_SELECTION_METHOD> foregroundSelectionCond = new ConditionalParameter<>(foregroundSelectionMethod)
            .setActionParameters(FOREGROUND_SELECTION_METHOD.SIMPLE_THRESHOLDING, bckThldCond)
            .setActionParameters(FOREGROUND_SELECTION_METHOD.HYSTERESIS_THRESHOLDING, bckThldCond, foreThldCond)
            .setActionParameters(FOREGROUND_SELECTION_METHOD.EDGE_FUSION, backgroundEdgeFusionThld,backgroundSelCond)
            .setEmphasized(true)
    ...
    EnumChoiceParameter<CONTOUR_ADJUSTMENT_METHOD> contourAdjustmentMethod = new EnumChoiceParameter<>("Contour adjustment", CONTOUR_ADJUSTMENT_METHOD.values(), CONTOUR_ADJUSTMENT_METHOD.NO_LOCAL_THLD).setEmphasized(true).setHint("Method for contour adjustment after segmentation");
    ...
    protected RegionPopulation filterRegionsAfterEdgeDetector(SegmentedObject parent, int structureIdx, RegionPopulation pop) {
        switch(foregroundSelectionMethod.getSelectedEnum()) {
