...
public class MicrochannelPhase2D implements MicrochannelSegmenter, TestableProcessingPlugin, Hint, TrackConfigurable<MicrochannelPhase2D> {
    ...
    NumberParameter closedEndYAdjustWindow = new BoundedNumberParameter("Closed-end Y Adjust Window", 0, 5, 0, null).setHint("Window (in pixels) within which y-coordinate of the closed-end of microchannel will be refined, by searching for the first local maximum of the Y-derivate within the window: [y-this value; y+this value]");
