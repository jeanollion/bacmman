...
public class BacteriaPhaseContrast extends BacteriaIntensitySegmenter<BacteriaPhaseContrast> {
    ...
    @Override public RegionPopulation runSegmenter(Image input, int objectClassIdx, SegmentedObject parent) {
        ...
        return filterBorderArtefacts(parent, objectClassIdx, pop);
    }
    ...
    /**
     * See {@link #getFilterBorderArtefacts(SegmentedObject, int) }
     * @param parent
     * @param structureIdx
     * @param pop
     * @return 
     */
    protected RegionPopulation filterBorderArtefacts(SegmentedObject parent, int structureIdx, RegionPopulation pop) {
     ...
     */
    protected Function<Region, Integer> getFilterBorderArtefacts(SegmentedObject parent, int structureIdx) {
