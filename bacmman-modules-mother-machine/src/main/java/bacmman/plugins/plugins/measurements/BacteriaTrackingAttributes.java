...
public class BacteriaTrackingAttributes implements Measurement, Hint {
    ...
    public String getHintText() {
        return "Extracts various attributes generated by the bacteria tracker (only available when the selected tracker is <em>BacteriaClosedMicrochannelTrackerLocalCorrections</em>). <ul><li><em>SizeRatio</em>: size of a bacterium divided by the size previous bacterium</li><li><em>TrackErrorSizeRatio</em>: Whether the tracker detected an error due to a size ratio out of the normal range</li><li><em>EndOfChannelContact</em>: Quantification of the contact between a bacterium and the open-end of the channel (the value is the size of the intersection between a bacterium and the opened-end of a microchannel divided by the width of the bacterium)</li><li><em>TruncatedDivision</em>: Whether the tracker detected a truncated division, i.e. a division with one of the daughter cell missing</li></ul>";
    }
