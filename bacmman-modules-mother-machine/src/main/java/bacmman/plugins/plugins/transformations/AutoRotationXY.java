...
public class AutoRotationXY implements MultichannelTransformation, ConfigurableTransformation, TestableOperation, Hint, HintSimple {
    ...
    EnumChoiceParameter<InterpolationScheme> interpolation = new EnumChoiceParameter<>("Interpolation", ImageTransformation.InterpolationScheme.values(), ImageTransformation.InterpolationScheme.BSPLINE5).setHint("The interpolation scheme to be used"+ImageTransformation.INTERPOLATION_HINT);
