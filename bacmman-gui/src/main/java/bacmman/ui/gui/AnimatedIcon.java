...
public class AnimatedIcon implements Icon, ActionListener, Runnable
{
     ...
     */
    public AnimatedIcon(Icon... icons)
    {
        this(DEFAULT_DELAY, icons);
    }
    ...
    {
        this(delay, DEFAULT_CYCLES, icons);
    }
     ...
     *  @param icons	  the Icons to be painted as part of the animation
     */
    public AnimatedIcon(int delay, int cycles, Icon... icons) {
        setCycles( cycles );
    ...
    public void setCurrentIconIndex(int index)
    {
        ...
        if (component!=null) {
            if (iconX!=Integer.MAX_VALUE && iconY!=Integer.MAX_VALUE) component.repaint(iconX, iconY, iconWidth, iconHeight);
            else component.repaint();
        }
...
//
    ...
    public void setComponent(Component c) {
        setComponent(c, Integer.MAX_VALUE, Integer.MIN_VALUE);
    }
