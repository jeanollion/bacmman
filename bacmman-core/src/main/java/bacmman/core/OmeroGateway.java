...
public interface OmeroGateway {
    ...
    static String decryptPassword(String server, String username, char[] password) throws GeneralSecurityException {
    ...
    static void encryptPassword(String server, String username, char[] localPassword, char[] remotePassword) throws GeneralSecurityException {
