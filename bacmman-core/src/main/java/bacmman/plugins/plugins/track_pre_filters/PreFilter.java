...
public class PreFilter implements TrackPreFilter, Hint, TestableProcessingPlugin {
    ...
    public static PreFilter[] getPreFilterArray(PreFilterSequence preFilters) {
    ...
    public void filter(int structureIdx, SegmentedObjectImageMap preFilteredImages) {
        ...
        ThreadRunner.parallelExecutionBySegments(c, 0, track.size(), 100, s -> Core.waitDiskManagerFreeMemory());
    }
