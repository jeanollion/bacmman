...
public class MeanFilter implements PreFilter, Filter, Hint {
    ...
    public MeanFilter(double radiusXY, double radiusZ) {
    ...
    public static Image filter(Image input, double radiusXY, double radiusZ, boolean parallele) {
        return Filters.mean(input, null, Filters.getNeighborhood(radiusXY, radiusZ, input), parallele);
    }
    @Override
    ...
    public String getHintText() {
        return "Classical Mean filter, often used to reduce noise";
    }
}
