 ...
 * @author Jean Ollion
 */
public class BandPass implements PreFilter, Transformation.Filter, Hint {
    ...
    ConditionalParameter<String> stripes = new ConditionalParameter<>(removeStripes).setDefaultParameters(new Parameter[]{stripeTolerance}).setActionParameters("None", new Parameter[0]);
    ...
    @Override public Image runPreFilter(Image input, ImageMask mask, boolean allowInplaceModification) {
