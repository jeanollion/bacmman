...
public class StandardDeviation implements PreFilter, Filter, Hint {
    ...
    public String getHintText() {
        return "Computes the local Standard Deviation of the image within an Ellipsoidal neighborhood defined by the <em>Radius</em> parameter. Optionally it can perform a median filtering before, in order to reduce noise (available in advanced mode)";
    }
}
