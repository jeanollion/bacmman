...
public class ContainerObject implements Measurement, Hint {
    ...
    public String getHintText() {
        return "For each object A (of class defined in <em>Objects</em>), this method searches for the the object B (of class defined in <em>Container Object</em>) that contains A. If B exists, this module returns its index (name: "+key.getValue()+"Idx) and/or its full barcode (index and index of the parent objects) (name: "+key.getValue()+"Indices)";
    }
