...
public class ImageFloat8Scale extends ImageFloatingPoint<ImageFloat8Scale> {
    ...
    public ImageFloat8Scale duplicate(String name) {
        ...
        return (ImageFloat8Scale)new ImageFloat8Scale(name, sizeX, newPixels, scale).setCalibration(this).translate(this);
    }
