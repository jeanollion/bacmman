 ...
 * @author Jean Ollion
 */
public class WatershedTransformCoordSet {
    public final static Logger logger = LoggerFactory.getLogger(WatershedTransformCoordSet.class);
    ...
    public static RegionPopulation watershed(Image watershedMap, ImageMask mask, List<Region> regionalExtrema, WatershedConfiguration config) {
        WatershedTransformCoordSet wt = new WatershedTransformCoordSet(watershedMap, mask, regionalExtrema, config);
        wt.run();
     ...
     * @param config watershed configuration
     */
    public WatershedTransformCoordSet(Image watershedMap, ImageMask mask, List<Region> regionalExtrema, WatershedConfiguration config) {
        ...
        //Core.showImage(segmentedMap.duplicate("seg map at init"));
    ...
    public WatershedTransformCoordSet setFusionCriterion(FusionCriterion fusionCriterion) {
        this.fusionCriterion=fusionCriterion;
        fusionCriterion.setUp(this);
        return this;
    }
    
    public WatershedTransformCoordSet setPropagationCriterion(PropagationCriterion propagationCriterion) {
    ...
    public void runDirectSegmentation() {
        throw new RuntimeException("Opertation not supported");
    }
    ...
    public interface PropagationCriterion {
        public void setUp(WatershedTransformCoordSet instance);
    ...
    public static class DefaultPropagationCriterion implements PropagationCriterion {
        ...
        @Override public void setUp(WatershedTransformCoordSet instance) {}
    }
    public static class MonotonalPropagation implements PropagationCriterion {
        boolean decreasingPropagation;
        WatershedTransformCoordSet instance;
        @Override public void setUp(WatershedTransformCoordSet instance) {
    ...
    public static class ThresholdPropagation implements PropagationCriterion {
        ...
        @Override public void setUp(WatershedTransformCoordSet instance) {this.instance=instance;}
        @Override public boolean continuePropagation(long currentVox, long nextVox) {
    ...
    public static class LocalThresholdPropagation implements PropagationCriterion {
        ...
        boolean stopWhenInferior;
        WatershedTransformCoordSet wst;
