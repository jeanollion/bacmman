 ...
 * @author Jean Ollion
 */
public class MemoryObjectDAO<ID> implements ObjectDAO<ID> {
    static final Logger logger = LoggerFactory.getLogger(MemoryObjectDAO.class);
    final MasterDAO<ID, ObjectDAO<ID>> masterDAO;
    Map<Integer, SegmentedObject> rootTrack;
    final String fieldName;
    final Function<Integer, ID> idGenerator;
    public MemoryObjectDAO(MasterDAO<ID, ObjectDAO<ID>> masterDAO, Function<Integer, ID> idGenerator, List<SegmentedObject> rootTrack) {
    ...
    public MemoryObjectDAO(MasterDAO<ID, ObjectDAO<ID>> masterDAO, Function<Integer, ID> idGenerator, String position) {
        this.masterDAO=masterDAO;
    ...
    @Override public void compactDBs(boolean onlyOpened) {}
    ...
    @Override
    public SegmentedObject getById(int structureIdx, ID id, int frame, ID parentTrackHeadId) {
        if (frame>=0) {
