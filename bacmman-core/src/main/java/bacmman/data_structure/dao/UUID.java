...
public final class UUID implements Comparable<UUID>, Serializable {
    ...
    public static UUIDGenerator generator() {
        return new UUIDGenerator();
    }
    public static class UUIDGenerator implements Function<Integer, String> {
        @Override
     ...
     */
    public UUID(final Date date, final int counter) {
     ...
     */
    public UUID(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     */
    public UUID(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
        this(timestamp, machineIdentifier, processIdentifier, counter, true);
    }

    private UUID(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter,
     ...
     */
    public UUID(final String hexString) {
