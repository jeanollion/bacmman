...
public class ImageManipulationTest {
    ...
    public void testImageSimpleConversion() {
        ImageInt imInt = new ImageInt("im test int", 2, 2, 2);
        imInt.setPixel(0, 1, 1, Integer.MAX_VALUE/100);
        ...
        assertEquals("Read voxel value: int cast to float", imFloat.getPixel(0, 0, 1), 2d);
        assertEquals("Read voxel value: int max value cast to float", Integer.MAX_VALUE/100, imFloat.getPixel(0, 1, 1), 0.1d);
